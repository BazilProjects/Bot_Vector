...
symbol_list = [
    'GBPAUDm',  # Gold/US Dollar (Commodity)
    ...
    for symbol in symbol_list:
        try:
            ...
            if not df.empty:
                ...
                best_testing_size_stop=np.arange(1,6,1)
                best_not_above=np.arange(18,19,1)
                best_testing_size=np.arange(2,3,1)
